				...
				<div id="contact">
					<div id="facebook-container" className="container">
						...
						<div className="text-container">
							Visit <a href="https://www.facebook.com/sunshineswhereeverlovegrows/" target="_blank" rel="noopener">Climber's Home Facebook Page</a> to see what is going on at the hostel or to get in touch through Messenger.
						</div>
					</div>
					...
					<div id="address-container" className="container">
						<div className="icon-container">
							<a href="https://www.google.com/maps/place/488+N+Main+St,+Stanton,+KY+40380/@37.8523327,-83.856699,148m/data=!3m2!1e3!4b1!4m5!3m4!1s0x88439e7ae5b69337:0x52199d2bd0002bc0!8m2!3d37.8523316!4d-83.8561518" target="_blank" rel="noopener"><i className="fas fa-map-marker-alt"></i></a>
						</div>
						<div className="text-container">
